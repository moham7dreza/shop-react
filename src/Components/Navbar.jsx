    ...
    return (
        <>
            ...
            <header className="flex flex-wrap lg:justify-start lg:flex-nowrap z-50 w-full py-7">
                           ...
                           href="../templates/creative-agency/index.html" aria-label="Preline">
                            <svg className="w-28 h-auto" width="116" height="32" viewBox="0 0 116 32" fill="none"
                                ...
                                <path
                                    ...
                                    className="fill-black dark:fill-white" fill="currentColor"/>
                                <path
                                    d="M1 29.5V16.5C1 9.87258 6.37258 4.5 13 4.5C19.6274 4.5 25 9.87258 25 16.5C25 23.1274 19.6274 28.5 13 28.5H12"
                                    className="stroke-black dark:stroke-white" stroke="currentColor" strokeWidth="2"/>
                                <path
          	...
          	<span className="">
        	    <svg className=" size-4 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
              ...
              <span className="relative flex">
                <span
                    className="animate-ping absolute inline-flex size-full rounded-full bg-red-400 dark:bg-red-600 opacity-75"></span>
                ...
                <span className="sr-only">Notification</span>
                                ...
                                {/*<!-- Dropdown */}
                                <div
                                    className="hs-dropdown-menu hs-dropdown-open:opacity-100 w-full md:w-[450px] transition-[opacity,margin] duration opacity-0 hidden z-30 overflow-hidden border border-gray-200 bg-white rounded-xl shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:bg-neutral-800 dark:border-neutral-700"
                                    role="menu" aria-orientation="vertical"
                                    aria-labelledby="hs-dropdown-preview-navbar">
                                    {/*<!-- Tab */}
                                    <div
                                        className="p-3 pb-0 flex flex-wrap justify-between items-center gap-3 border-b border-gray-200 dark:border-neutral-700">
                                        {/*<!-- Nav Tab */}
                                    ...
                                    {/*<!-- Tab Content */}
                                    <div id="hs-pmn-pro" className="hidden" role="tabpanel"
                                         aria-labelledby="hs-pmn-item-pro">
                                        {/*<!-- Header */}
                                        <div className="p-3 flex flex-wrap justify-between items-center gap-3">
                                            <span
                                                className="block font-semibold text-sm text-gray-800 dark:text-neutral-200">Templates (12)</span>

                                            <div className="ms-auto">
                                                <a className="group py-2 px-2.5 rounded-md flex items-center gap-x-1 text-[13px] bg-gray-800 text-white hover:bg-gray-900 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-900 dark:bg-white dark:hover:bg-neutral-200 dark:focus:bg-neutral-200 dark:text-neutral-800"
                                        ...
                                        {/*<!-- Body */}
                                        <div
                                            className="p-3 max-h-[25rem] overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                                            {/*<!-- Grid */}
                                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                                {/*<!-- Link */}
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/dashboard/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img1.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/shop/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img21.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/chat/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img16.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
        	            ...
        	            <span className="py-0.5 px-2 inline-flex items-center gap-x-1.5 text-xs font-medium
                                                                 bg-emerald-100 text-emerald-800 rounded-full
                                                                 dark:bg-emerald-900 dark:text-emerald-500">+4</span>
                                                    </div>
                                                </a>
                                                {/*<!-- End Link */}

                                                {/* <!-- Link */}
                                                <a className=" p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl
                                                                 hover:bg-gray-100 focus:outline-none focus:bg-gray-100
                                                                 dark:hover
                                                            :bg-neutral-700 dark:focus:bg-neutral-700 transition"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/payment/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img8.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/ecommerce/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img4.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/calendars/day.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img14.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/workspace/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img18.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/analytics/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img9.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/project/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img10.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/saas/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img11.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../pro/files/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/demo-previews/img12.jpg" alt="Main Page"/>
                                                    <img className="hidden dark:block w-28 rounded-lg shadow"
                                        ...
                                        <div className="p-3 flex flex-wrap justify-center items-center gap-0.5">
                                            <div
                                                className="relative ps-2 ms-1 first:ps-0 first:ms-0 first:before:hidden before:hidden md:before:block before:absolute before:top-1/2 before:start-0 before:w-px before:h-4 before:bg-gray-200 before:-translate-y-1/2 dark:before:bg-neutral-700">
                                                <a className="group flex items-center gap-x-1.5 py-1.5 px-2 rounded-md text-[13px] text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                                                   href="../pro/index.html">
                                                    Main page
                                                    <svg className="shrink-0 size-3.5"
                                                         xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    {/*<!-- Tab Content */}
                                    <div id="hs-pmn-free" className="" role="tabpanel"
                                         aria-labelledby="hs-pmn-item-free">
                                        {/*<!-- Header */}
                                        <div className="p-3 flex flex-wrap justify-between items-center gap-3">
                                            <span
                                                className="block font-semibold text-sm text-gray-800 dark:text-neutral-200">Templates (5)</span>
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../templates/agency/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/template-previews/img1.jpg" alt="Main Page"/>
                                                        <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../templates/personal/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/template-previews/img3.jpg" alt="Main Page"/>
                                                        <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../templates/admin/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/template-previews/img7.jpg" alt="Main Page"/>
                                                        <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                {/*<!-- Link */}
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 bg-gray-100 dark:bg-neutral-700 transition"
                                                   href="../templates/creative-agency/index.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/template-previews/img2.jpg" alt="Main Page"/>
                                                        <img className="hidden dark:block w-28 rounded-lg shadow"
                                                ...
                                                <a className="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                   href="../templates/ai-prompt/ai-with-sidebar.html">
                                                    <img className="dark:hidden w-28 rounded-lg shadow"
                                                         src="../assets/img/template-previews/img4.jpg" alt="Main Page"/>
                                                        <img className="hidden dark:block w-28 rounded-lg shadow"
                    ...
                    <div className="flex items-center gap-x-1 lg:gap-x-2 ms-auto py-1 lg:ps-6 lg:order-3 lg:col-span-3">
                        ...
                        <div className="lg:hidden">
                            <button type="button"
                                ...
                                <svg className="hs-collapse-open:hidden shrink-0 size-4"
                    ...
                    <div id="hs-navbar-hcail"
                        ...
                        <div
                            ...
                            <div>
                                <a className="relative inline-block text-black focus:outline-none before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 dark:text-white"
                                   href="#" aria-current="page">Work</a>
                            </div>
                            <div>
                                <a className="inline-block text-black hover:text-gray-600 focus:outline-none focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-neutral-300"
                                   href="#">Services</a>
                            </div>
                            <div>
                                <a className="inline-block text-black hover:text-gray-600 focus:outline-none focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-neutral-300"
