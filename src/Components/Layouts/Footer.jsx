                ...
                <div className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        ...
                        <div className="col-span-1">
                            <h4 className="font-semibold text-gray-100">تست</h4>
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="mt-3 grid space-y-3">
                                ...
                                <p><a
                                    className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                    href="#">تست</a> <span
                                    className="inline ms-1 text-xs bg-blue-700 text-white py-1 px-2 rounded-lg">تست</span>
                                </p>
                                <p><a
                                    className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                    href="#">تست</a></p>
                            ...
                            <form>
                                <div
                                    ...
                                    <div className="w-full">
                                        <label htmlFor="hero-input" className="sr-only">تست</label>
                    ...
                    <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
                        <div className="flex justify-between items-center">
                            <p className="text-sm text-gray-400">تست</p>
                        </div>
                        {/* End Col -->*/}
