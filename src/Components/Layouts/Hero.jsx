                ...
                <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
                    <div className="text-center">
                        <h1 className="text-4xl sm:text-5xl font-bold text-gray-800 dark:text-gray-200">
                            تو اینجا همه جوره برنده ای
                        </h1>

                        <p className="mt-12 text-gray-600 dark:text-gray-400">
                            مقایسه کن و بهترینو پیدا کن
                        </p>

                        <div className="mt-12 m:mt-12 mx-auto max-w-xl relative">
                            {/*!-- Form -->*/}
                            <form>
                                <div
                                    className="relative z-10 flex space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-slate-900 dark:border-gray-700 dark:shadow-gray-900/[.2]">
                                    <div className="flex-[1_0_0%]">
                                        <label htmlFor="hs-search-article-1"
                                               className="block text-sm text-gray-700 font-medium dark:text-white"><span
                                            className="sr-only">دنبال چی میگردی ...</span></label>
                            ...
                            <div className="hidden md:block absolute bottom-0 start-0 translate-y-10 -translate-x-32"
                                 dir={'ltr'}>
                                <svg className="w-40 h-auto text-cyan-500" width="347" height="188"
